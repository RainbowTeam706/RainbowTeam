<!-- 此页面为“学生”点击主页面某一具体活动后跳转，显示活动信息、PPT预览、活动详情、底部导航 -->
<template>
  <div class="speech-page">
    ...
    <div class="main-content">
      ...
      <div class="detail-content">
        <!-- <div class="invite-code">邀请码：{{ activity.inviteCode }}</div> 只有老师显示邀请码？-->
    ...
    <div class="bottom-nav-student">
      <div class="nav-item" :class="{ active: activeTab === 'test' }" @click="activeTab = 'test'">
...
<script setup>
import { ref } from 'vue'
import { ArrowLeft, Document, ChatDotRound, Comment } from '@element-plus/icons-vue'
